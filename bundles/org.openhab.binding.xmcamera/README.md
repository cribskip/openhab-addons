...
This binding integrates (cheap) Xiongmaitech IP cameras into openHAB.

## Supported Things

This binding currently supports IP cameras as audio sink.
...
```
# Configuration for the XMCamera Binding
#
# Default secret key for the pairing of the XMCamera Thing.
